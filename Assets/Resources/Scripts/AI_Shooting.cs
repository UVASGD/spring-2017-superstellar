...
public class AI_Shooting : Photon.MonoBehaviour {
	...
	//variables
	public float lifetime; // how long projectiles stay on screen
	public float projForce; // how much force the projectiles are given when shot
	public int starPointNum; // how many points the star has
	public int maxPointHealth; // how much health the projectiles have
	public int maxPointDam; // how much damage the projectiles give when they collide with something
	public int maxPlayerHealth; // how much health the player has at full health
	public int maxPlayerDam; // how much damage the player gives when they collide with something
	public float playerRegen; // how quickly the player regenerates their health
	public Material starMat; // the material of the star
	public float starSize; // how quickly the player regenerates their health
	public float reloadTime; //time to regen point
	public float colReload;
...
//		proj.tag = this.tag;
		proj.GetComponent<Health_Management> ().viewID = this.GetComponent<PhotonView> ().viewID;
	...
	//you will need to change this to point towards the player : NOTICE THIS!
	void rotate() {
